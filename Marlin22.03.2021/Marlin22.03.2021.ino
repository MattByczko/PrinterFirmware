 ...
 * NOTE:
 * 
 * Run M502 to restore memory from the hardcoded values here, 
 * then run M500 to save,
 * then m501 to show again to ensure its saved
 *  m503 shows defaults too
 * 
 * 
 * to get values in 0 and +
 * 
 * g92 x0 when homed
 * m500
 * m428
 * m500
 * centyred bed, then m114 and verified it was in positiove x
 * 
================================================================================

  Marlin Firmwareg92 x0
